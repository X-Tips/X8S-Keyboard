...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT( //Alphabet
		...
		XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, MO(1), KC_LSFT,                KC_SPC, MO(2), KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX), 
	...
	[1] = LAYOUT( //Numpad and Punctuation
		...
		KC_LCTL, KC_1, KC_2, KC_3, KC_EQL, KC_ASTR,                        KC_BSLS, KC_AT, KC_CIRC, KC_LPRN, KC_RPRN, KC_UNDS,  
		XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, TO(0), LSFT_T(KC_BSPC),        KC_PENT, LGUI(KC_SPC), KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX), 
	...
	[2] = LAYOUT( //Punctuation and Arrow key
		...
		KC_LCTL, MO(3), XXXXXXX, XXXXXXX, KC_VOLD, KC_VOLU,                KC_MPRV, KC_MNXT, KC_MPLY, KC_MUTE, KC_PAUS, KC_PSCR,   
		XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, KC_CAPS, KC_LSFT,              KC_SPC, TO(0), KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX), 
